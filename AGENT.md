# help users manage — Agent Implementation Guide
...
## Project: help users manage
**Primary goal:** help users manage and organize household chores and tasks
**Problem being solved:** household chore management
**Target users:** Parents with young children living together
**Pages:** Home, task list, login, Metrics
**Sections:** Hero, assign tasks to family members, set deadlines for tasks, receive notifications for upcoming task deadlines, Who it is for, Primary call to action
**Features:** assign tasks to family members, set deadlines for tasks, receive notifications for upcoming task deadlines, task list, login, Responsive layout
